...
const _quiz = <_Question>[
  ...
  _Question('prioritas', 'Paling penting?', 'Memilih profil bobot AHP → ranking menyesuaikan', [
    ['keamanan', 'Keamanan Anak', '🛡️'],
    ['edukasi', 'Nilai Edukasi', '🎓'],
    ['harga', 'Harga Termurah', '💵'],
    ['tahan', 'Awet & Tahan Lama', '💪'],
  ]),
];
...
class _RecommendationScreenState extends ConsumerState<RecommendationScreen> {
  ...
  Widget build(BuildContext context) {
    return ScreenWrapper(
      ...
      child: _isResult ? _buildResult() : _buildQuiz(),
    );
  }
  ...
  Widget _buildQuiz() {
    ...
    final progress = (_step + 1) / _quiz.length;
      ...
      children: [
        Padding(
          ...
          child: Column(
            ...
            children: [
              Text('Langkah ${_step + 1}/${_quiz.length}', style: AppTypography.labelSmall),
        ...
        Expanded(
          child: ListView(
            ...
            children: [
              ...
              const SizedBox(height: AppSpacing.xs),
              Text(q.subtitle, style: AppTypography.bodyMedium.copyWith(color: AppColors.textSecondary)),
        ...
        Padding(
          padding: const EdgeInsets.all(AppSpacing.md),
          child: AppButton(
            label: _step < _quiz.length - 1 ? 'Lanjut' : 'Lihat Rekomendasi',
            isFullWidth: true,
        ...
        return ListView(
          ...
          children: [
            ...
            if (rec.primary.isNotEmpty) ...[
              Text('Sesuai pilihanmu · ${rec.primary.length} mainan', style: AppTypography.labelMedium),
              const SizedBox(height: AppSpacing.sm),
            ...
            const SizedBox(height: AppSpacing.sm),
            AppButton(label: 'Ubah Preferensi', variant: AppButtonVariant.outline, isFullWidth: true, onPressed: _restart),
          ],
        );
      },
    );
